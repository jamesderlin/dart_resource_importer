...
void main() {
  ...
  group('Overwrite tests: ', () {
    ...
    const yaml = //
        ...
        '  resources:\n'
        '    someStringResource:\n'
        "      path: 'assets/short.txt'\n"
        '      type: String\n';
    var fs = MemoryFileSystem()
      ..addFile('pubspec.yaml', content: yaml)
      ..addFile('assets/short.txt', content: 'Hello world!');

    test('Overwrites existing generated file', () async {
      fs.addFile(
        destinationPath,
        content:
